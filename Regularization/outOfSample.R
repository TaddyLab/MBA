...
##LESLIE this isn't part of the semiconductor example
...
##LESLIE semiconductor example starts here
...
##LESLIE this is the OJ data, so not semiconductor
...
##LESLIE this is where the semiconductor examples picks back up
...
cvScLasso$lambda.1se #lambda value for 1se rule
log(cvScLasso$lambda.1se)
cvScLasso$lambda.min #lambda value for CV-min rule
